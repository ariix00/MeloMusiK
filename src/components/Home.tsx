  ...
  return (
    <div className="mt-20 flex flex-col  w-4/5">
      ...
      <div className="flex gap-20 w-full justify-center">
        <div className="flex flex-col w-1/2 text-xl font-light justify-center  gap-10">
          <h3 className="">
        ...
        <div className="flex w-1/2 gap-5 justify-center">
          <img
            src={image1}
            alt=""
            className="h-[600px] w-64 object-cover rounded-t-full rounded-b-full  border-1 border-slate-50/59 bg-transparent p-1"
          />
          <div className="flex flex-col gap-5">
            <img
              src={image1}
              className="bg-blue-300 rounded-full h-1/3 w-52 object-cover"
            />
            <img
              src={image1}
              className="bg-blue-300 rounded-t-full rounded-b-full grow w-52 object-cover"
            />
          </div>
        </div>
      </div>
